...
CREATE INDEX IDX_TIMELINE_MEMBER_STATE ON Timeline (memberId, state);
...
CREATE INDEX IDX_PRODUCT_PT_TS ON Product (productType, testState);
...
CREATE INDEX IDX_ACCOUNT_MEMBER_STATE ON Account (memberId, state);
