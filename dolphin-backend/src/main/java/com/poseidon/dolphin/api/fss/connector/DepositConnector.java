...
public class DepositConnector implements Connector<FSSDepositResult> {

	@Override
	public FSSDepositResult connect(String apiKey, FinanceGroup financeGroup, int pageNo)
			throws ClientProtocolException, URISyntaxException, IOException {
		return FSSClient.connect(FSSDepositResult.class, apiKey, ServiceUrl.DEPOSIT_PRODUCTS_SEARCH, financeGroup, pageNo);
	}
