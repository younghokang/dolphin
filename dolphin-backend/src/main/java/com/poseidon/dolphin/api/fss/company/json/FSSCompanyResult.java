...
public class FSSCompanyResult {
	...
	private List<FSSCompany> baseList;
	private List<FSSCompanyOption> optionList;
	...
	public List<FSSCompany> getBaseList() {
		return baseList;
	}
	public void setBaseList(List<FSSCompany> baseList) {
		this.baseList = baseList;
	}
	public List<FSSCompanyOption> getOptionList() {
		return optionList;
	}
	public void setOptionList(List<FSSCompanyOption> optionList) {
		this.optionList = optionList;
	}
	@Override
	public String toString() {
		return "FSSCompanyResult [prdt_div=" + prdt_div + ", err_cd=" + err_cd + ", err_msg=" + err_msg
